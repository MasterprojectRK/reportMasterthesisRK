...
Farr\'e et al. propose a window size of $w=80$ at binsizes $b_{feat} = b_{mat} = \SI{10}{\kilo\bp}$,
...
The results of the \acrshort{cgan} with CNN embedding are shown in \cref{sec:results:cgan_cnn} 
