...
First and foremost, there seems no consensus on the exact definition of \acrshort{tad}s, 
...
amended by two kinds of embedding networks for the chromatin features, which serve as the conditional input $x$ here.
...
The \emph{generator} architecture is based the well known \emph{U-Net} architecture due to Ronneberger, Fischer and Brox \cite{Ronneberger2015},
