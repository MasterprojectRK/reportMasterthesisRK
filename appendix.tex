...
\end{figure}
\clearpage
\subsubsection{cGAN trained on K562, predicting GM12878}
\begin{figure}[h!] %cGAN 256 K-on-G, pearson and progress
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{learning progress} \label{fig:results:GAN256_K-on-G_lossEpochs}
    \end{subfigure}
    \caption{results\,/\,metrics cGAN, CNN embedding, $w=256$, test chromosomes}   \label{fig:results:GAN256_K-on-G_pearson}
\end{figure}
\begin{figure}[p] %cgan mixed 64, pretrained, matrices
    \begin{subfigure}{\textwidth}
        ...
        \caption{example  region 1} \label{fig:results:GAN256_K-on-G_r1}
    \end{subfigure}\\[3mm]
    \begin{subfigure}{\textwidth}
        \centering
        \resizebox{0.9\textwidth}{!}{
        ...
        \caption{example region 2} \label{fig:results:GAN256_K-on-Gr2}
    \end{subfigure}\\[3mm]
\end{figure}
\begin{figure}\ContinuedFloat
    \begin{subfigure}{\textwidth}
        ...
        \caption{example region 3} \label{fig:results:GAN256_K-on-G_r3}
    \end{subfigure}
    \caption{example predictions cGAN, CNN embedding, $w=256$, 60 epochs} 
     \label{fig:results:GAN256_K-on-G_matrices}
\end{figure}
\clearpage
\subsubsection{cGAN trained on single chromosomes predicting usual test chromosomes}
