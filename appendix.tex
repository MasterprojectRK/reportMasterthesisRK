...
\begin{figure}[htbp]
    \centering
    \scriptsize
    \raggedright{The figure below shows the effect of choosing too large loss weights for the TV loss\\in combined loss functions according to \cref{sec:methods:combined_loss}.\\[2mm]}
...
\begin{figure}[p] %cGAN trained on drosophila 2L, 2R 
    ...
    \end{subfigure}
    \caption{Results\,/\,metrics cGAN, $w=64$, trained on D. Lancaster chr2L and 2R}   \label{fig:appendix:GAN64_drosophila_pearson}
\end{figure}
\begin{figure}[htbp]
\begin{subfigure}{\textwidth}
 \centering
