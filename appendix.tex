...
\end{figure}
\begin{figure}[p] %cgan K562 on G12878
    \begin{subfigure}{\textwidth}
        \centering
...
\begin{figure}[p] %cGAN single chrom 14, matrices
    \scriptsize{\centering{predicted matrices on top, true matrices at bottom\\}}
    \begin{subfigure}{\textwidth}
        \centering
        \resizebox{0.9\textwidth}{!}{
        \scriptsize
...
\end{figure}
\begin{figure}[ptb]%ICE-normalized predicted matrix vs. ICE normalized target matrix
 \begin{subfigure}{\textwidth}
  ...
  \centering
  \scriptsize
  \import{figures/GAN_64_drosophila/}{pred00100_ICE_chr3R_1675-2175.pdf_tex}
...
\begin{subfigure}{\textwidth}
 \centering\scriptsize{predicted and ICE-normalized matrix on top, ICE-normalized matrix derived from Schuettengruber et al. \cite{Schuettengruber2014} on bottom;\\
  ...
  \centering
  \scriptsize
  \import{figures/GAN_64_drosophila/}{pred00100_ICE_chr3R_1675-2175_rb.pdf_tex}
