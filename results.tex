...
It is obvious that all predicted test matrices had a strictly positive Pearson correlation with respect to the experimentally derived matrices by Rao et al. \cite{Rao2014},
but were not better than simply taking data from the training cell line as prediction for the target cell line.
