...
A comparasion between the DNN- and cGAN approaches discussed in this paper and the
random-forest-based method by Zhang et al., HiC-Reg \cite{Zhang2019}, is shown in  \cref{fig:results:pearson_zhang-vs-ours} and \ref{fig:results:matrices_zhang-vs-ours}.
