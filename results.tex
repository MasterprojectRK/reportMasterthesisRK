...
both in terms of Pearson correlations and in terms of matrix plots, \cref{fig:results:widerDNN_pearson}.
Given the small increase in the number of trainable parameters, this is not surprising.
