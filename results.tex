...
but structures sized approximately 500 to \SI{1000}{\kilo\bp} appeared more clearly and the ``intersecting point'' on the Pearson correlation graphs 
...
The effect was more pronounced for chromosome 17, which indeed yields less training samples.
...
\end{subfigure}\\[4mm]
    \centering{\scriptsize{See \cref{sec:methods:matrix_plots} for track explanations. Predicted matrices on top, true matrices on bottom}}\\[5mm]
    \begin{subfigure}{\textwidth}
 \centering
 \scriptsize
