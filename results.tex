...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, basic \acrshort{dnn}, \SI{25}{\kilo\bp}, 500 epochs} \label{fig:results:basic500}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, basic \acrshort{dnn}, \SI{25}{\kilo\bp}, 1000 epochs} \label{fig:results:basic1000}
\end{figure}
%10k matrices
\begin{figure}[p]
    \begin{subfigure}{\textwidth}
    ...
    \end{subfigure}
    \caption{example predictions, basic \acrshort{dnn} \SI{10}{\kilo\bp}, 1000 epochs}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, ``wider'' variant of \acrshort{dnn} \SI{25}{\kilo\bp}, 1000 epochs}\label{fig:results:wider_matrices}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, ``longer'' variant of \acrshort{dnn} \SI{25}{\kilo\bp}, 1000 epochs} \label{fig:results:longer_matrices}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, ``wider-longer'' variant of \acrshort{dnn} \SI{25}{\kilo\bp}, 1000 epochs} \label{fig:results:wider-longer_matrices}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, ``5k -- 25k'' variant of \acrshort{dnn}, 1000 epochs} \label{fig:results:25k5_matrices}
\end{figure}
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{dnn} with combined loss function (MSE, TV, VGG-16), 500 epochs} \label{fig:results:combiloss_matrices}
\end{figure}
...
\begin{figure}[p] %score loss matrices
    ...
    \end{subfigure}
    \caption{example predictions,  \acrshort{dnn} with score-based loss function, 500 epochs} \label{fig:results:scoreloss_matrices}
\end{figure}
...
\begin{figure}[p] %50k direct, matrices
    ...
    \end{subfigure}
    \caption{example predictions,  \acrshort{dnn} at \SI{50}{\kilo\bp} direct, 250 epochs} \label{fig:results:50k_matrices}
\end{figure}
\begin{figure}[p] %50k from 25k, matrices
    ...
    \end{subfigure}
    \caption{example predictions,  \acrshort{dnn} trained at \SI{25}{\kilo\bp} predicting at \SI{50}{\kilo\bp}, 500 epochs} \label{fig:results:50k_from25k_matrices}
\end{figure}
...
\begin{figure}[p] %25plus50, matrices at 25k
    ...
    \end{subfigure}
    \caption{example predictions,  \acrshort{dnn} trained at \SI{25}{\kilo\bp} and \SI{50}{\kilo\bp} simultaneously, \SI{25}{\kilo\bp}, 500 epochs}\label{fig:results:25plus50_matrices}
\end{figure}
...
\begin{figure}[p] %cgan with DNN, no pre-training, winsize 64, matrices
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{dnn} embedding, no pre-training, $w=64$, 60 epochs} \label{fig:results:cGAN64-dnn_matrices}
\end{figure}
...
\begin{figure}[p] %cgan with DNN, pretrained, winsize 64, matrices
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{dnn} embedding, pre-trained, $w=64$, 100 epochs} \label{fig:results:cGAN64_pretrain-dnn_matrices}
\end{figure}
...
\begin{figure}[p] %cgan CNN, 64, matrices
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{cnn} embedding, $w=64$, 80 epochs}
...
\begin{figure}[p] %cgan CNN, 128, matrices
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{cnn} embedding, $w=128$, 90 epochs} \label{fig:results:cGAN128_matrices}
\end{figure}
...
\begin{figure}[p] %cgan CNN, 256k, matrices
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{cnn} embedding, $w=256$, 100 epochs}
\end{figure}
\begin{figure}\ContinuedFloat
    ...
    \end{subfigure}
    \caption{example predictions, \acrshort{cgan}, \acrshort{cnn} embedding, $w=256$, 100 epochs} \label{fig:results:cGAN256_matrices}
\end{figure}
...
\begin{figure}[p] %cgan mixed 64, pretrained, matrices
    ...
    \end{subfigure}
    \caption{example predictions \acrshort{cgan}, mixed embedding, \acrshort{dnn} pre-trained, $w=64$, 40 epochs} 
