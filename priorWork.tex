...
and the results could not be reproduced for unknown reasons -- neither using
the provided source code nor own implementations from the two study projects \cite{Krauth2020,Bajorat2019} .
