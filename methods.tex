...
To asses the quality of the predicted matrices within this thesis, distance-stratified Pearson correlations were computed between predicted and real matrices.
...
distance stratified Pearson correlation is quite common in practice and thus useful at least for comparisons with other approaches.
...
Since relying on metrics alone seemed problematic, pygenometracks \cite{LopezDelisle2020} was used to plot selected areas of the test set 
where the changes made within this thesis seemed particularly obvious.
...
The network and its learning algorithm were implemented in python using tensorflow deep learning framework, partially with keras frontend \cite{tensorflow2015-whitepaper,chollet2015keras}, 
see repository \xxx.
