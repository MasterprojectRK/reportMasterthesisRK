...
However, the usual distance-stratified correlations for all test chromosomes are shown in the appendix, figures \xxx and \xxx.
Like the distance-stratified-correlation plots, per-position-correlation figures were generated by a custom python script \xxx.
