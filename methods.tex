...
For the comparsion with the DNN- and \acrshort{cgan} approach and for the transfer from GM12878, the full matrices (including zeros) where considered,
...
\SI{20}{\giga\byte} of main memory, as in machine 2, were not enough to train the \acrshort{cgan} at windowsize 64 for more than 80 epochs.
