...
For example, if region index $i=1$ corresponded to ``chr1, 25000...49999'' and index $j=10$ corresponded to ``chr1, 250000...274999'',
...
in the Encyclopedia of DNA elements \cite{Encode2012,Davis2017}, and these have been produced by only five university labs.
...
sorted by total number of selected assays available, where TF stands for Transcription Factor.
Although not necessarily all publicly known experiments to date are included in ENCODE -- 
